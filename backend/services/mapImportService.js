...
/* ─── advancedPointList / advancedCurveList 파싱 (smap 형식) ─── */
...
async function parseNodesEdges(json) {
  ...
  return Map.create({
    ...
    additional_info: JSON.stringify({
      header: json.header || {},
      normalPosList: json.normalPosList || [],
    }),
  });
}
